...
@Component({
  selector: 'app-j-query-chart',
  templateUrl: './j-query-chart.component.html',
  styleUrls: ['./j-query-chart.component.scss']
})
export class JQueryChartComponent implements OnInit {
  public title = {
